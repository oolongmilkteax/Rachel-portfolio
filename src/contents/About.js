...
class About extends Component {
    render() {
        ...
        <div className="aboutpage">
            <div className = "about">
                <h1 className = "aboutheading">About Me <i class="far fa-address-card"></i></h1> 
                <h2>Hey there!</h2>
                ...
                I realised that more companies were starting to embrace big data and analytics, which meant an increase in demand for such skillsets.<br/><br/>
