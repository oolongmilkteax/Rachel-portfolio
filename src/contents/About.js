    ...
    render() {
        ...
        <div className="aboutpage">
            <div className = "about">
                ...
                I was shocked to find out how much our clients were willing to spend on collecting data and it made me wonder what they were going to do with them and how it would be useful.
                I started doing some research on my own and it took my down the rabbit hole of analytics.                
                I realised that more companies were starting to embrace big data and analytics, which meant an inrease in demand for such skillsets.
